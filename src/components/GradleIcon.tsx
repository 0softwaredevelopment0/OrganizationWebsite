// The official Gradle elephant mark (Simple Icons, CC0).
// Font Awesome has no Gradle icon, so this is rendered as an inline SVG that
// follows the text color like the FA icons do (fill: currentColor).

export default function GradleIcon({
  className,
  style,
}: {
  className?: string;
